...
@Component({
  selector: 'app-cambiar-logo-header',
  templateUrl: './cambiar-logo-header.component.html',
  styleUrls: []
})
export class CambiarLogoHeaderComponent implements OnInit {
  @Input() data;
  envioForm: FormGroup;
  ...
  subirImg(data: any){
    ...
    this.loading = true;
    this.agenciaService.changeLogoHeader(this.logoHeader)
      .subscribe( data => {
        this.loading = false;
